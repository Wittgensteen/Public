...
from apps import default_graphics as my_graphics


# Файл с разметкой страниц.
# 'serve_layout' нужен для работы с несколькими вкладками,
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            html.H6(id='market-graph-tab-string',
                                                    # figure=my_graphics.generate_stack_graph_deals(),
                                                    style={'display': 'none'}),
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            dcc.Graph(id='LLR, (E)TR, LLR/(E)TR-pie-2017-RU',
                                                      figure=my_graphics.update_pie_graph_llr_etr_2017_ru(),
                                                      style={'display': 'none',
                                                             # 'padding-top': '20px'
                                                             }
                                                      ),
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            dcc.Graph(id='LLR, (E)TR, LLR/(E)TR-pie-1Q2018-RU',
                                                      figure=my_graphics.update_pie_graph_llr_etr_1q2018_ru(),
                                                      style={'display': 'none'}),
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            dcc.Graph(id='LLR, (E)TR, LLR/(E)TR-pie-five-years-RU',
                                                      figure=my_graphics.pie_graph_five_years_llr_tr(),
                                                      style={'display': 'none'}),
...
def presentation_list():
    return html.Div(
        [
            html.Div(  # основной div 'page'
                [
                    my_method.print_button(),
                    html.A(id='button-scr', children='screenshot', href='javascript:genScreenshot()'),
                    html.A(id='test'),


                    html.Div(  # дочерний div 'subpage'
                        [
                            html.Div(  # div с заголовком слайда
                                [
                                ...
                                [
                                    html.Div(
                                        [
                                            dcc.Graph(
                                                id='pie-1-pres-act',
                                                figure=my_graphics.pie_graph_for_pres_ru_1q2018_sale_lease(),
                                                style={
                                                    # 'width': '500',
                                                    'padding-left': '130px'}
                                            ),
                                            ...
                                            html.Div(
                                                children='Аренда и продажа (Россия)',
                                                style={
                                                    'font-weight': 'bold',
                                                    "padding-left": "50px",
                                                    "margin-bottom": "10px",
                                            ...
                                            html.Div(
                                                id='table-1-pres',
                                                children=my_graphics.generate_table_for_pres_sale_lease_ru(),
                                                style={
                                                    'margin-left': '25px',
                                                    "padding-left": "25px",
                                                    # 'allign': 'left'
                                    ...
                                    html.Div(
                                        [
                                            dcc.Graph(
                                                id='pie-2-pres-act',
                                                figure=my_graphics.pie_graph_for_pres_ru_1q2018_lease(),
                                                style={
                                                    # 'width': '500',
                                                    'margin-left': '80px'}
                                            ),
                                            ...
                                            html.Div(
                                                id='table-1-pres',
                                                children=my_graphics.generate_table_for_pres_lease_ru(),
                                                style={
                                                    'margin-left': '25px',
                                                    "padding-left": "25px",
                                                    # 'allign': 'left'
                        ...
                        style={
                            ...
                            'background-image': 'url(https://raw.githubusercontent.com/Wittgensteen/work_stuff/master/bck.png)',
